        ...
        if ($firstProduct) {
            DB::table('media')->insertOrIgnore([
                [
                    ...
                    'type' => 'image',
                    'role' => 'main',
                    'url' => 'https://picsum.photos/seed/gaza-hoodie-1/800/800',
                ...
                [
                    ...
                    'thumbnail' => 'https://placehold.co/400x300/jpg?text=Video',
        ...
        for ($i = 0; $i < $chunks; $i++) {
            ...
            for ($j = 0; $j < $remaining; $j++) {
                ...
                $mediaItem = [
                    ...
                    'type' => $type,
                    'role' => $faker->boolean(15) ? 'main' : 'sub',
                    'url' => $type === 'image' 
                        ? 'https://picsum.photos/seed/' . $faker->uuid . '/800/600'
                        : 'https://filesamples.com/samples/video/mp4/sample_640x360.mp4',
                    'alt_text' => $faker->sentence(3),
                    'thumbnail' => $type === 'video' ? 'https://placehold.co/400x300/jpg?text=Video' : null,
