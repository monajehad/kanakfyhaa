...
<div class="row mb-4">
  <div class="col-md-12">
    <h4>{{ __('Create Package') }} - {{ $product->name_ar ?? $product->name }}</h4>
    <small class="text-muted">{{ __('Manage packages for this product') }}</small>
  </div>
</div>
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" 
                value="{{ old('name') }}" placeholder="e.g., Basic, Premium, Deluxe" required>
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" name="description_ar" 
                rows="2" placeholder="الوصف بالعربية">{{ old('description_ar') }}</textarea>
            ...
            <div class="col-md-6">
              ...
              <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" 
                rows="2" placeholder="Description in English">{{ old('description_en') }}</textarea>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <input type="number" step="0.01" class="form-control @error('original_price') is-invalid @enderror" id="original_price" name="original_price" 
                value="{{ old('original_price') }}" placeholder="Leave blank to use price">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <input type="number" step="0.01" class="form-control @error('shipping_price') is-invalid @enderror" id="shipping_price" name="shipping_price" 
                value="{{ old('shipping_price', 0) }}" placeholder="0.00">
    ...
    <div class="col-md-4">
      ...
      <div class="d-grid gap-2">
        <button type="submit" class="btn btn-primary">
          <i class="bx bx-check"></i> {{ __('Create Package') }}
        </button>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    let itemIndex = {{ count(old('items', [['name' => '']])) }};
